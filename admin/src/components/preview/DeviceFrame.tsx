...
export function DeviceFrame({ device, maxWidth = 320, children }: DeviceFrameProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div
        className="relative overflow-hidden rounded-[2rem] border-2 border-outline bg-black"
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-1">
            <div className="w-3 h-2 border border-on-surface-muted rounded-sm">
              <div className="w-2 h-1 bg-on-surface-muted rounded-sm" />
            </div>
          </div>
        </div>
