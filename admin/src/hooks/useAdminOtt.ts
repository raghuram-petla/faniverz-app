...
export const useAddMoviePlatform = createSimpleMutation<
  { movie_id: string; platform_id: string; available_from?: string | null; streaming_url?: string | null },
  MoviePlatform
>({
  mutationFn: (release) => crudFetch<MoviePlatform>('POST', { table: 'movie_platforms', data: release }),
